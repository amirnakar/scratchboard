...
setwd(wd.path)
3. Saving & loading data
Note: I skipped the part about csv files My notes start here https://youtu.be/Y3Nzz6WEl_E?t=200
summary: num | Action | Function — | — | — 1. |To read/write data|write.csv / read.csv 2. |To read/write R objects|saveRDS() / readRDS() 3. |To save/load R environments|save.image() / load()
Hide
...
summary
n	function	notes
1	filter	To filter specificrows. Just like EXCEL
2	select	To select specificcolumns
